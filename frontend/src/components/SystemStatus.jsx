        ...
        <div className="glass-card p-4 sm:p-6 animate-slide-up">
            ...
            <div className="space-y-3">
                {items.map(({ icon: ItemIcon, label, value, sub, badge, dot }) => (
                    <div key={label} className="flex items-center gap-3">
                        <ItemIcon className="w-4 h-4 text-gray-400 dark:text-gray-600" />
            ...
            <button
                ...
                className="mt-5 w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl
                   bg-brand-500/15 dark:bg-brand-600/20 hover:bg-brand-500/25 dark:hover:bg-brand-600/30
                   border border-brand-400/25 dark:border-brand-500/20 hover:border-brand-400/50 dark:hover:border-brand-500/40
                   text-brand-600 dark:text-brand-300 text-sm font-medium transition-all duration-200
