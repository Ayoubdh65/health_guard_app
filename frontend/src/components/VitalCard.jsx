    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mb-3 relative z-10">
                ...
                {value != null && (
                    <span
                        className={`vital-badge ${status.bgColor} ${status.textColor} text-[10px] font-semibold`}
                    >
            ...
            {value != null && alert && (
                <div className="mt-3 relative z-10">
                    <div className="h-1 w-full bg-gray-800 rounded-full overflow-hidden">
                        ...
                        {/* Marker dot */}
                        <div
                            className={`absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full shadow-md ${barFillClass}`}
                            style={{
                                left: `calc(${status.rangePct * 100}% - 4px)`,
                            }}
                        />
                    </div>
                    {/* Low / High labels */}
            ...
            {isAlert && status.advice && (
                <p className="text-[10px] text-gray-500 italic mt-2 leading-snug relative z-10">
                    {status.advice}
                </p>
            )}
